  ...
  export default {
    ...
    data() {
      return {
        ...
        candidateUsers: [{id: '1', name: 'clyi'}, {id: '2', name: 'Steven'}, {id: '3', name: 'Andy'}],
        candidateGroups: [{id: '1', name: '工程师1'}, {id: '2', name: '工程师2'}, {id: '3', name: '工程师3'}],
        categorys: [{id: '1', name: '发电机厂房'}, {id: '2', name: '发电机厂房2'}, {id: '3', name: '发电机厂房3'}],
      }
    },
    computed: {
      height() {
        return window.innerHeight - 47
      }
    },
    mounted() {
    }
